...
const Project = () => {
  return (
    <div className="pt-16 pb-16">
      ...
      <div className="w-[70%] mx-auto grid grid-cols-1 gap-15 mt-16 md:grid-cols-2">
        {/* First Project */}
        <Link
        ...
        {/* Second Project */}
        <Link
          href="https://dashboard-pi-puce.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="block"
        >
        ...
        >
          ...
          >
            ...
            <h1 className="pt-2 font-medium text-white/80">
              ReactJs • Redux Toolkit • Rest APIs
            </h1>
          </div>
        </Link>
        ...
        {/* Fourth Project */}
        <Link
          href="https://portfolio-uwn1.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="block"
        >
